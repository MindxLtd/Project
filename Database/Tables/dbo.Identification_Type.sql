...
CREATE TABLE [dbo].[Identification_Type](
	[AY_Identification_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_IDENT_TYPE] [nvarchar](max) NULL,
	[AY_F_IDENTITY_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_IDENTITYTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Identification_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Identification_Type_Id] ASC
