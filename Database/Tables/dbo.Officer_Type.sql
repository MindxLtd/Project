...
CREATE TABLE [dbo].[Officer_Type](
	[AY_OFFICER_TYPE_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_OFFICER_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_OFFICERTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Officer_Type] PRIMARY KEY CLUSTERED 
(
	[AY_OFFICER_TYPE_ID] ASC
