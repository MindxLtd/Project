...
CREATE TABLE [dbo].[Country](
	[AY_F_Country_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	...
	[AY_F_CTRY_TEXT] [nvarchar](max) NULL,
	[AY_F_CTRY_ISO] [nvarchar](max) NULL,
	[AY_F_IDD_CODE] [nvarchar](max) NULL,
	...
	FOREIGN KEY ([AY_F_CURR_Id]) REFERENCES [Currency]([AY_F_CURR_Id]),
