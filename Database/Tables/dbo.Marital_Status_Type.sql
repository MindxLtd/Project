...
CREATE TABLE [dbo].[Marital_Status_Type](
	[AY_Marital_Status_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_MARISTAT_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_MARISTATTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Marital_Status_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Marital_Status_Type_Id] ASC
