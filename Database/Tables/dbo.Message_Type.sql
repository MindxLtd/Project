...
CREATE TABLE [dbo].[Message_Type](
	[AY_F_Message_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_MESSG_TYPE] [nvarchar](max) NULL,
	[AY_F_MESSG_TEXT] [nvarchar](max) NULL,
	[AY_F_APPL_TYPE_Id] int NULL,
	...
	FOREIGN KEY ([AY_F_APPL_TYPE_Id]) REFERENCES [Application_Type]([AY_F_APPL_Id]),
 CONSTRAINT [PK_Message_Type] PRIMARY KEY CLUSTERED 
(
	[AY_F_Message_Type_Id] ASC
