...
CREATE TABLE [dbo].[Communication_Type](
	[AY_F_Communication_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_COMM_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_COMM_CAT] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_COMMUNICATION_CATEGORY_ID] int null,
	[AY_F_COMMCAT_TEXT] [nvarchar](max) NULL,
	...
	FOREIGN KEY ([AY_COMMUNICATION_CATEGORY_ID]) REFERENCES [Communication_Category]([AY_COMMUNICATION_CATEGORY_ID]),
	FOREIGN KEY ([AY_F_LANG_ID]) REFERENCES [Language]([AY_F_LANG_Id]),
 CONSTRAINT [PK_Communication_Type] PRIMARY KEY CLUSTERED 
(
	[AY_F_Communication_Type_Id] ASC
