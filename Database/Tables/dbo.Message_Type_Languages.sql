...
CREATE TABLE [dbo].[Message_Type_Languages](
	[AY_F_Message_Type_Languages_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_MESSG_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_MESS_Type_ID] int NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_APPL_TEXT] [nvarchar](max) NULL,
	...
	FOREIGN KEY ([AY_F_MESS_Type_ID]) REFERENCES [Message_Type]([AY_F_Message_Type_Id]),
	FOREIGN KEY ([AY_F_LANG_ID]) REFERENCES [Language]([AY_F_LANG_Id]),
 CONSTRAINT [PK_Message_Type_Languages] PRIMARY KEY CLUSTERED 
(
	[AY_F_Message_Type_Languages_Id] ASC
