...
CREATE TABLE [dbo].[Legal_Persons](
	[AY_Legal_Persons_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_LEGPER_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_LEGPERTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Legal_Persons] PRIMARY KEY CLUSTERED 
(
	[AY_Legal_Persons_Id] ASC
