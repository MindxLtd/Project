...
CREATE TABLE [dbo].[FX_Rate_Source](
	[AY_FX_RATE_SOURCE_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_FXSRC_CODE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_FXSRC_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_FX_Rate_Source] PRIMARY KEY CLUSTERED 
(
	[AY_FX_RATE_SOURCE_ID] ASC
