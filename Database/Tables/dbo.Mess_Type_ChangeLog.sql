...
CREATE TABLE [dbo].[MESS_Type_ChangeLog](
	[AY_F_MESS_Type_CL_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
 ...
 CONSTRAINT [PK_MESS_Type_ChangeLog] PRIMARY KEY CLUSTERED 
(
	[AY_F_MESS_Type_CL_Id] ASC
