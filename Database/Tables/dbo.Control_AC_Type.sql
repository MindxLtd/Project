...
CREATE TABLE [dbo].[Control_AC_Type](
	[AY_Control_AC_Type_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_GLCTRL_TYPE] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Control_AC_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Control_AC_Type_ID] ASC
