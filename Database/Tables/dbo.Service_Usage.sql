...
CREATE TABLE [dbo].[Service_Usage](
	[AY_Service_Usage_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_SERV_USAGE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_SERV_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Service_Usage_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Service_Usage_Id] ASC
