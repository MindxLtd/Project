...
CREATE TABLE [dbo].[GL_Account_Text](
	[AY_F_GL_Account_Text_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_GL_ACCTNO] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_COA_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_Chart_Of_Accounts_ID] int null,
	[AY_F_GLACCT_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_GL_Account_Text] PRIMARY KEY CLUSTERED 
(
	[AY_F_GL_Account_Text_Id] ASC
