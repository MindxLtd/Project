...
CREATE TABLE [dbo].[Currency_Category_ChangeLog](
	[AY_F_CL_CURR_CT_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
 ...
 CONSTRAINT [PK_Currency_Category_ChangeLog] PRIMARY KEY CLUSTERED 
(
	[AY_F_CL_CURR_CT_Id] ASC
