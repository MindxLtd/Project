...
CREATE TABLE [dbo].[State_Region](
	[AY_F_State_Region_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_CTRY_CODE] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_Country_Id] int NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_STATE_CODE] [nvarchar](max) NULL,
	[AY_F_STATE_TEXT] [nvarchar](max) NULL,
	[AY_F_STATE_TIZO] [nvarchar](max) NULL,
	[AY_F_STATE_ISO] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_State_Region] PRIMARY KEY CLUSTERED 
(
	[AY_F_State_Region_Id] ASC
