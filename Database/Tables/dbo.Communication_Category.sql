...
CREATE TABLE [dbo].[Communication_Category](
	[AY_COMMUNICATION_CATEGORY_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
 ...
 CONSTRAINT [PK_Communication_Category] PRIMARY KEY CLUSTERED 
(
	[AY_COMMUNICATION_CATEGORY_ID] ASC
