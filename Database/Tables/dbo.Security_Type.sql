...
CREATE TABLE [dbo].[Security_Type](
	[AY_Security_Type_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_SECURITY_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_SECURITYTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Security_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Security_Type_ID] ASC
