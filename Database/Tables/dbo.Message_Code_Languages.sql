...
CREATE TABLE [dbo].[Message_Codes_Languages](
	[AY_F_Message_Codes_Languages_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
 ...
 CONSTRAINT [PK_Message_Codes_Languages] PRIMARY KEY CLUSTERED 
(
	[AY_F_Message_Codes_Languages_Id] ASC
