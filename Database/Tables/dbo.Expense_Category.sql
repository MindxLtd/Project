...
CREATE TABLE [dbo].[Expense_Category](
	[AY_F_Expense_Category_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_EXP_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_EXP_CAT] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_Communication_Type_Id_Self] int null,
	[AY_F_EXPTYTEXT] [nvarchar](max) NULL,
	...
	FOREIGN KEY ([AY_F_Communication_Type_Id_Self]) REFERENCES [Expense_Category]([AY_F_Expense_Category_Id]),
	FOREIGN KEY ([AY_F_LANG_ID]) REFERENCES [Language]([AY_F_LANG_Id]),
 CONSTRAINT [PK_Expense_Category] PRIMARY KEY CLUSTERED 
(
	[AY_F_Expense_Category_Id] ASC
