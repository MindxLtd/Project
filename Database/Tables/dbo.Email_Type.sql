...
CREATE TABLE [dbo].[Email_Type](
	[AY_Email_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_EMAIL_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_EMAIL_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Email_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Email_Type_Id] ASC
