...
CREATE TABLE [dbo].[Mode_Of_Transport](
	[AY_Mode_Of_Transport_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_MOT_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_MOTTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Mode_Of_Transport] PRIMARY KEY CLUSTERED 
(
	[AY_Mode_Of_Transport_ID] ASC
