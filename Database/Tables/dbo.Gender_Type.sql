...
CREATE TABLE [dbo].[Gender_Type](
	[AY_Gender_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_GENDER_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_GENDERTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Gender_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Gender_Type_Id] ASC
