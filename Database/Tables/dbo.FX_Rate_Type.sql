...
CREATE TABLE [dbo].[FX_Rate_Type](
	[AY_FX_RATE_TYPE_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_FXRATE_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_FXRATETY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_FX_Rate_Type] PRIMARY KEY CLUSTERED 
(
	[AY_FX_RATE_TYPE_ID] ASC
