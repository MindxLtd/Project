...
CREATE TABLE [dbo].[Currency_Category_AppType_Languages](
	[AY_F_CURR_CT_APPL_Lan_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_CURR_CAT] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_APPL_TEXT] [nvarchar](max) NULL,
	[AY_F_CURR_CT_Id] INT NULL,
	...
	FOREIGN KEY ([AY_F_CURR_CT_Id]) REFERENCES [Currency_Category]([AY_F_CURR_CT_Id]),
	FOREIGN KEY ([AY_F_LANG_ID]) REFERENCES [Language]([AY_F_LANG_Id]),
 CONSTRAINT [PK_Currency_Category_AppType_Languages] PRIMARY KEY CLUSTERED 
(
	[AY_F_CURR_CT_APPL_Lan_Id] ASC
