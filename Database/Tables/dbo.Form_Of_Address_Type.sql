...
CREATE TABLE [dbo].[Form_Of_Address_Type](
	[AY_Form_Of_Address_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_T_FOA_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_FOA_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Form_Of_Address_Type] PRIMARY KEY CLUSTERED 
(
	[AY_Form_Of_Address_Type_Id] ASC
