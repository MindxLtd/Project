...
CREATE TABLE [dbo].[Chart_Of_Accounts](
	[AY_Chart_Of_Accounts_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_COA_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_COATY_TEXT] [nvarchar](max) NULL,
	[AY_F_GL_LENGTH] [nvarchar](max) NULL,
	[AY_F_LEGAL_COA] [nvarchar](max) NULL,
