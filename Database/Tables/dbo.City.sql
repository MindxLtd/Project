...
CREATE TABLE [dbo].[City](
	[AY_F_City_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	...
	[AY_F_State_Region_Id] int null,
	[AY_F_CITY_TEXT] [nvarchar](max) NULL,
	[AY_F_TIZO_CODE] [nvarchar](max) NULL,
	[AY_F_City_Time_Zone] [nvarchar](max) NULL,
	...
	FOREIGN KEY ([AY_F_State_Region_Id]) REFERENCES [State_Region]([AY_F_State_Region_Id]),
