...
CREATE TABLE [dbo].[Address_Type](
	[AY_Address_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_ADDR_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_ADDR_TEXT] [nvarchar](max) NULL,
	[AY_F_COMPH_REL] [nvarchar](max) NULL,
