...
CREATE TABLE [dbo].[Port_Type](
	[AY_F_Port_Type_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	...
	[AY_F_PORTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Port_Type] PRIMARY KEY CLUSTERED 
(
	[AY_F_Port_Type_Id] ASC
