...
CREATE TABLE [dbo].[Application_Type_Languages](
	[AY_F_APPL_Lan_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
 ...
 CONSTRAINT [PK_Application_Type_Languages] PRIMARY KEY CLUSTERED 
(
	[AY_F_APPL_Lan_Id] ASC
