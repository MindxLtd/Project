...
CREATE TABLE [dbo].[Priority_Type](
	[AY_PRIORITY_TYPE_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_PRIORITY_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_PRIORITYTY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Priority_Type] PRIMARY KEY CLUSTERED 
(
	[AY_PRIORITY_TYPE_ID] ASC
