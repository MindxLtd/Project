...
CREATE TABLE [dbo].[Currency_Languages](
	[AY_F_CURR_Lan_Id] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_CURR_CODE] [nvarchar](max) NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_CURR_ID] int NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_CURR_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Currency_Languages] PRIMARY KEY CLUSTERED 
(
	[AY_F_CURR_Lan_Id] ASC
