...
CREATE TABLE [dbo].[Lease_Type](
	[AY_LEASE_TYPE_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_LEASE_TYPE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_LEASETY_TEXT] [nvarchar](max) NULL,
 ...
 CONSTRAINT [PK_Lease_Type] PRIMARY KEY CLUSTERED 
(
	[AY_LEASE_TYPE_ID] ASC
