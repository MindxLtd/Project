...
CREATE TABLE [dbo].[GL_Account_Type](
	[AY_GL_Account_Type_ID] [int] IDENTITY(1,1) NOT NULL,
	[AY_ENV_ID] int NULL,
	[AY_F_COA_CODE] [nvarchar](max) NULL,
	[AY_F_LANG_ID] int NULL,
	[AY_F_LANG_CODE] [nvarchar](max) NULL,
	[AY_F_GLACCT_TYPE] [nvarchar](max) NULL,
	[AY_F_TRANSTY_TEXT] [nvarchar](max) NULL,
	[AY_F_GLTYPE_FR] [nvarchar](max) NULL,
	[AY_F_GLTYPE_TO] [nvarchar](max) NULL,
